...
- what the registry serves is what was built: `ada-agent-wallet@0.2.4` on npm is byte for byte the
  tarball checked before publishing (20 files, shasum `87f7ffb1…`, the one `npm publish` printed).
  Installed from the registry into an empty directory, it brings `subbit-x402@0.1.4` and one copy
  ...
  Earlier releases were checked the same way: 0.2.3 (`dde3cc15…`), 0.2.2 (`b27996d7…`), 0.2.1
